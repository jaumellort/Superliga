...
import com.superliga.jllort.bencosuperleague.users.ItemFragment.OnListFragmentInteractionListener;
...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemRecyclerViewAdapter(List<User> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
